...
/**
 * SearchCategoryScrapGost represents the model behind the search form about `common\models\CategoryScrapGost`.
 */
class SearchCategoryScrapGost extends CategoryScrapGost
{
    ...
    public function search($params)
    {
        ...
        if (!($this->load($params) && $this->validate())) {
            /**
             * Жадная загрузка данных модели упращеннох категорий мет-ма
       ...
       /* $this->load($params);
        ...
        $query->andFilterWhere(['like', 'category_scrap_gost.name', $this->name]);
