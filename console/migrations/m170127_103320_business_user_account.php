...
class m170127_103320_business_user_account extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%business_user_account}}', [
            'id_business_user_account' => $this->primaryKey(),
            ...
            'landline_phone' => $this->integer()->unique(),
            'company_name' => $this->char(255)->notNull(),
        ], $tableOptions);
    }

    public function down()
    {
        $this->dropTable('{{%business_user_account}}');
    }
